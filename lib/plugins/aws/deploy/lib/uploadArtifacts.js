...
const proxy = process.env.proxy
    ...
    console.log("uploadArtifacts PROXY IS " + proxy);
...
module.exports = {
  ...
  uploadCloudFormationFile() {
    ...
    console.log("this.provider is " + Object.keys(this.provider));
...
const proxy = process.env.proxy
    ...
    this.provider.sdk.config.httpOptions.agent = new ffs(url.parse(proxy));
